...
#Initialise Django package
sys.path.append("/Users/yrish/Documents/UoL_Docs/UoL_Modules_Lectures/Seventh_Semetre/Advanced_Web_Dev/Topic_1_Mine/topic2/bioweb")
#sys.path.append('/Users/yrish/.virtualenvs/advanced_web_dev/lib/python3.11/site-packages/django')
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'bioweb.settings')

django.setup()
from genedata.models import *
data_file = "/Users/yrish/Documents/UoL_Docs/UoL_Modules_Lectures/Seventh_Semetre/Advanced_Web_Dev/Topic_1_Mine/topic2/example_data_to_load.csv"
